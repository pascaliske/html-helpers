...
import { namespace, stringToMap, flatDeep } from './helpers'
...
/**
 * Returns all given class names joined by an empty string.
 *
 * @param classes - An array of class names to join.
 * @returns A class string.
 */
